...
/** @constructor */
function $c_Ledu_trinity_webapps_ScalaJSExample$() {
  $c_O.call(this)
}
$c_Ledu_trinity_webapps_ScalaJSExample$.prototype = new $h_O();
$c_Ledu_trinity_webapps_ScalaJSExample$.prototype.constructor = $c_Ledu_trinity_webapps_ScalaJSExample$;
/** @constructor */
function $h_Ledu_trinity_webapps_ScalaJSExample$() {
  /*<skip>*/
}
$h_Ledu_trinity_webapps_ScalaJSExample$.prototype = $c_Ledu_trinity_webapps_ScalaJSExample$.prototype;
$c_Ledu_trinity_webapps_ScalaJSExample$.prototype.init___ = (function() {
  return this
});
$c_Ledu_trinity_webapps_ScalaJSExample$.prototype.main__AT__V = (function(args) {
...
var $d_Ledu_trinity_webapps_ScalaJSExample$ = new $TypeData().initClass({
  Ledu_trinity_webapps_ScalaJSExample$: 0
}, false, "edu.trinity.webapps.ScalaJSExample$", {
  Ledu_trinity_webapps_ScalaJSExample$: 1,
  O: 1
});
$c_Ledu_trinity_webapps_ScalaJSExample$.prototype.$classData = $d_Ledu_trinity_webapps_ScalaJSExample$;
var $n_Ledu_trinity_webapps_ScalaJSExample$ = (void 0);
function $m_Ledu_trinity_webapps_ScalaJSExample$() {
  if ((!$n_Ledu_trinity_webapps_ScalaJSExample$)) {
    $n_Ledu_trinity_webapps_ScalaJSExample$ = new $c_Ledu_trinity_webapps_ScalaJSExample$().init___()
  };
  return $n_Ledu_trinity_webapps_ScalaJSExample$
}
/** @constructor */
...
$m_Ledu_trinity_webapps_ScalaJSExample$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=interiordesign-client-fastopt.js.map
